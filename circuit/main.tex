...
$  python3 2_8.py
	...
	\begin{enumerate}[label=\thesection.\arabic*,ref=\thesection.\theenumi]
		...
		\solution On performing partial fraction decomposition
			...
			\begin{lstlisting}
$  wget https://raw.githubusercontent.com/HARI-donk-EY/sig_pros/main/circuit/codes/3_4.py
			\end{lstlisting}
...
$  python3 3_4.py
			...
			We get the Fig. \ref{fig:3.4}.

			\begin{figure}[h]
				\begin{center}
					\includegraphics[width=0.7\columnwidth]{figs/3_4}
				\end{center}
		...
		\solution\\
			...
			\begin{lstlisting}
$  wget https://raw.githubusercontent.com/HARI-donk-EY/sig_pros/main/circuit/codes/3_5.py
$  wget https://raw.githubusercontent.com/HARI-donk-EY/sig_pros/main/circuit/codes/3_5.cir
			\end{lstlisting}
...
$  python3 3_5.py
			...
			We get the Fig. \ref{fig:3.5}.\\

			\begin{figure}[h]
				\begin{center}
					\includegraphics[width=0.7\columnwidth]{figs/3_5}
				\end{center}
				\caption{Plot of $v_c(t)$ after flipping the switch, comparing it along side data obtained from ngspice}
				\label{fig:3.5}
			\end{figure}
			...
			\solution\\\\
				At $t = 0^-$, the switch still hasn't been switched to Q and the circuit is in steady state
				\begin{align}
